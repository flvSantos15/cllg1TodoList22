...
export function TodoList() {
  ...
  return (
    <div className="flex flex-col items-start m-auto my-16 p-0 gap-6 w-[46rem] h-[17.938rem] border border-solid xl:border-[red] md:border-[blue] sm:border-[green]">
      <div className="flex justify-between items-end p-0 w-full h-[1.188rem]">
        <div className="flex items-center p-0 gap-2 w-[8.688rem] h-full">
          <p className="font-[Inter] font-bold text-sm leading-[1.063rem] text-[#4ea8de]">
            Tarefas criadas
          </p>
        ...
        <div className="flex items-center p-0 gap-2 h-full">
          <p className="font-[Inter] font-bold text-sm leading-[1.063rem] text-[#8284fa]">
            Concluídas
          </p>
          {!todo.length ? (
            <div className="flex items-center w-[1.563rem] h-[1.188rem] py-0.5 px-2 gray-400 rounded-[62.438rem]">
          ...
          <>
            {todo.map((t) => {
              return (
                <div
                  key={t.id}
                  className="flex items-center p-4 gap-3 w-full h-[4.5rem] bg-[#262626] border border-solid border-[#333333] shadow-[0px_2px_8px_rgba(0,0,0,0.06)] rounded-lg"
                >
                  {t.isCompleted ? (
                    <BsCheckCircleFill
                      color="#8284fa"
